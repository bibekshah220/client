        ...
        <div className="mt-6 w-full h-full">
            ...
            <form className="w-full h-full">
                <div className="w-full h-full flex flex-col gap-8">
                    ...
                    <Input label="Retype Password" id="confirm_password" placeholder="xxxxxxxxxxx" type="password" />


                    {/* phone */}
                    <Input label="Phone Number" id="phone" placeholder="9865374070" type="text" />
                ...
                <div>
                    <p className="text-center mt-2 text-gray-700">Already have an Account?<span className="cursor-pointer text-blue-600 mx-2 font-semibold">Sign In</span></p>
                </div>
            </form>
        </div>
    )
